...
#define _05_TAU_CH1_INPUT_FSUB                  (0x05U) /* sub clock (fSUB) */
...
#define _00_TAU_EXTINT_INTP0                    (0x00U) /* uses the INTP0 pin as an external interrupt */
#define _01_TAU_EXTINT_RXD0                     (0x01U) /* uses RXD0 pin as an external interrupt */
/* Switching channel 5 input of timer array unit (ISC1) */
#define _00_TAU_CH5_NO_INPUT                    (0x00U) /* timer input is not used */
#define _02_TAU_CH5_RXD0_INPUT                  (0x02U) /* input signal of RxD0 pin is used as timer input */
...
/*
    A timer array unit and an output selection register (TOS)
*/
/* Remote control carrier power output selection */
#define _00_TAU_REMOTE_CONTROL_UNUSED           (0x00U) /* remote control carrier power output invalidity */
#define _01_TAU_REMOTE_CONTROL_USED             (0x01U) /* remote control carrier power output effective */   

/***********************************************************************************************************************
Macro definitions
***********************************************************************************************************************/
/* 16-bit timer data register 00 (TDR00) */
#define _0063_TAU_TDR00_VALUE                   (0x0063U)
/* 16-bit timer data register 01 (TDR01) */
#define _0032_TAU_TDR01_VALUE                   (0x0032U)
/* 16-bit timer data register 02 (TDR02) */
#define _0032_TAU_TDR02_VALUE                   (0x0032U)
/* Clock divisor for TAU0 channel 0 */
#define TAU0_CHANNEL0_DIVISOR                   (1U)
/* Clock divisor for TAU0 channel 1 */
#define TAU0_CHANNEL1_DIVISOR                   (1U)
/* Clock divisor for TAU0 channel 2 */
#define TAU0_CHANNEL2_DIVISOR                   (1U)
/* 16-bit timer data register 03 (TDR03) */
#define _03E7_TAU_TDR03_VALUE                   (0x03E7U)
/* Clock divisor for TAU0 channel 3 */
#define TAU0_CHANNEL3_DIVISOR                   (1U)
/* 16-bit timer data register 04 (TDR04) */
#define _0063_TAU_TDR04_VALUE                   (0x0063U)
/* Clock divisor for TAU0 channel 4 */
#define TAU0_CHANNEL4_DIVISOR                   (1U)
/* 16-bit timer data register 05 (TDR05) */
#define _0063_TAU_TDR05_VALUE                   (0x0063U)
/* Clock divisor for TAU0 channel 5 */
#define TAU0_CHANNEL5_DIVISOR                   (1U)
